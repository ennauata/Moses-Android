...
import com.moses.Bin.BillBin;
import com.moses.DAO.BillsDAO;
import com.moses.DAO.GroupDAO;
import com.moses.DAO.UserDAO;
import com.moses.Moses.MosesApplication;
...
public class WebServiceHandler {
	...
	private GraphUser UserToAddInfo;
	...
	public GraphUser getUserToAddInfo() {
		return UserToAddInfo;
	}

	public void setUserToAddInfo(GraphUser userToAddInfo) {
	...
	private class sendPostTask extends AsyncTask<String, String, String> {
		...
		private JSONObject createGroupJSON() throws JSONException {
			JSONObject jsonParam = new JSONObject();
			JSONArray members = new JSONArray();
			List<GraphUser> usersToAdd = MosesApplication.getSelectedUsers();
